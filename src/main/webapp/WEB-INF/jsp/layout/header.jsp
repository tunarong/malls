...
<header>
    ...
    <div id="topnav">
        <h1 id="styles"><img src="/resources/img/logo_square.PNG" style=" height:75px; text-align-all: center;"/> </h1>
        <div>
    ...
    <div class="row" style="margin-top: 80px;">
        ...
        <!--쿠폰-->
        <div class="col-md-3">
            <span><a href="main.html"><img src="/resources/img/coupon.PNG" style="width: 200px; opacity: 0.7; margin-top: 10px; margin-left: 80px;"></a></span>
        </div><!--//헤더 우측-->
