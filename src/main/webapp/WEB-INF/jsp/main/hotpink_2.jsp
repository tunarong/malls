				...
				<div class="row">
					...
					<div class="col-xl-6">
						...
						<div style="padding-left: 20px;">
							<div class="item_name">브이 반팔 티셔츠</div><!-- Product Single - Price End -->
							<div class="product-price"><del>19000원</del> <ins class="sale_price">9000원</ins></div><!-- Product Single - Price End -->
