...
<center>
    <main id="main" class="main">
        <div class="shop">
            <img id="logo1" src="/resources/img/dong/shoplogo/66girlslogo.PNG" width="250px;" height="100px;" style="margin-left: auto; margin-right: auto; display: block;"/>
            ...
            <div class="products">
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/66girlsdong/66girls1동5.gif"/>
                        <figcaption>
                            <h3>양승혁</h3>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/66girlsdong/66girls1동6.gif"/>
                        <figcaption>
                            <h3>양승혁</h3>
                            <p>Weekends don't count unless you spend them doing something completely pointless.</p>
                        </figcaption>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/66girlsdong/66girls1동7.gif"/>
                        <figcaption>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/66girlsdong/66girls1동8.gif"/>
                        <figcaption>
                            <h3>[daily][inner]</h3>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/66girlsdong/66girls1동9.gif"/>
                        <figcaption>
                            <h3>양승혁</h3>
                            <p>Weekends don't count unless you spend them doing something completely pointless.</p>
                        </figcaption>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/66girlsdong/66girls1동10.gif"/>
                        <figcaption>
                            <h3>양승혁</h3>
                            <p>Weekends don't count unless you spend them doing something completely pointless.</p>
                        </figcaption>
