...
<center>
    <main id="main" class="main">
        <div class="shop">
            <img id="logo1" src="/resources/img/dong/shoplogo/ggsinglogo.PNG" width="250px;" height="100px;" style="margin-left: auto; margin-right: auto; display: block;"/>
            ...
            <div class="products">
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/ggsingdong/ggsing1동5.gif"/>
                        <figcaption>
                            <h3>[역대급!10만장돌파]</h3>
                            <p>145cm! 170cm까지 키별 옵션 선택가능! 스판5%와 겉에선 티나지않은 속밴드로 편안함까지</p>
                        </figcaption>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/ggsingdong/ggsing1동6.gif"/>
                        <figcaption>
                            <h3>양승혁</h3>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/ggsingdong/ggsing1동7.gif"/>
                        <figcaption>
                ...
                <li col-md-3 class="products1">
                    <figure><img src="/resources/img/dong/ggsingdong/ggsing1동10.gif"/>
                        <figcaption>
                            <h3>양승혁</h3>
                            <p>Weekends don't count unless you spend them doing something completely pointless.</p>
                        </figcaption>
